(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".pressa")) new core(".photoes__slider", {
            modules: [],
            observer: true,
            observeParents: true,
            slidesPerView: 5,
...
***************************************************************************** */
    ...
    window.onload = function() {
        ...
        function documentActions(e) {
            const targetElement = e.target;
            if (window.innerWidth > 880 && isMobile.any()) {
    ...
    const menuLinks = document.querySelectorAll(".sub-menu__link");
